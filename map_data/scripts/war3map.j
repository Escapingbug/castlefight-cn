...
call RemoveItem(C[i])set i=i+1exitwhen i>=Dendloopcall TimerStart(B,31.25,false,F)
endfunctionfunction yV takes nothing returns nothinglocal integer i=0set G=G+(3.)
loop
set C[i]=CreateItem('I000',GetRandomReal(GetRectMinX(Fn),GetRectMaxX(Fn)),GetRandomReal(GetRectMinY(Fn),GetRectMaxY(Fn)))call DestroyEffect(AddSpecialEffect("Abilities\\Spells\\Demon\\DarkPortal\\DarkPortalTarget.mdl",GetItemX(C[i]),GetItemY(C[i])))
set C[i+1]=CreateItem('I000',GetRandomReal(GetRectMinX(fn),GetRectMaxX(fn)),GetRandomReal(GetRectMinY(fn),GetRectMaxY(fn)))call DestroyEffect(AddSpecialEffect("Abilities\\Spells\\Demon\\DarkPortal\\DarkPortalTarget.mdl",GetItemX(C[i+1]),GetItemY(C[i+1])))
set i=i+(2)exitwhen i>=Dendloopcall TimerStart(B,4.75,false,function WV)endfunctionfunction YV takes nothing returns nothingcall DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffFFFF80Bounty incoming!|r")
call TimerStart(B,4.,false,function yV)endfunctionfunction zV takes player p returns nothinglocal integer id=GetPlayerId(p)local integer ZV=R2I(ko[id]*(8.+G))set Go[id]=Go[id]+1call DisplayTextToPlayer(p,.0,.0,"|cffFFFF80You found |cffFFFF00"+I2S(ZV)+"|cffFFFF80 gold!|r")set ho[id]=ho[id]+(ZV)call AdjustPlayerStateBJ(ZV,p,PLAYER_STATE_RESOURCE_GOLD)endfunctionfunction vE takes boolean eE returns nothing
if(B==null)thenreturnendifcall PauseTimer(B)if(eE)thencall PauseTimer(B)call DestroyTimer(B)
set B=nullendifendfunctionfunction xE takes nothing returns nothinglocal integer i=0if(yx<=0)thenreturnendifif(B==null)thenset B=CreateTimer()set D=yx*2endifset G=.0
loop
set H[i]=-1set i=i+1exitwhen i>=4endloopset H[4]=0set H[5]=0call TimerStart(B,40.,false,function YV)
...
call PauseTimer(Gv)endifif(Yx!=0)thenif(Gv==null)then
set Gv=CreateTimer()
endifcall TimerStart(Gv,(IAbsBJ(Yx)-5)*60.,false,function SE)
...
endfunctionfunction kX takes nothing returns nothingset Tv=GetRectMinX(bj_mapInitialPlayableArea)set Uv=GetRectMaxX(bj_mapInitialPlayableArea)set wv=GetRectMinY(bj_mapInitialPlayableArea)set Wv=GetRectMaxY(bj_mapInitialPlayableArea)endfunctionfunction KX takes unit lX,unit fV returns booleanlocal real x=wrlocal real y=Wrlocal real d
...
set Ve[id]=-1endifset Re[id]=qXset Xe[id]=trueset ae[id]=pXset Ae=Ae+1set Oe[Ne]=Aeset Oe[Ae+Ne]=pX
endfunctionfunction SX takes integer pX,integer tX returns nothingset ie[GetUnitPointValueByType(pX)]=tXendfunctionfunction TX takes unit u,integer uX,real an,real x,real y returns nothinglocal integer HE=GetUnitUserData(u)local real mx=GetUnitX(u)+xlocal real my=GetUnitY(u)+yset be=CreateUnit(GetOwningPlayer(u),uX,mx,my,an)call SetUnitPathing(be,false)call SetUnitX(be,mx)
call SetUnitY(be,my)
...
call RemoveUnit(ju)endifexitwhen wX<=0endloopset ju=nullendifendfunctionfunction yX takes integer pX,code YX returns nothing
local integer id=GetUnitPointValueByType(pX)
if(Be[id]!=null)then
call DisplayTextToPlayer(GetLocalPlayer(),.0,.0,"Conflict in Attach registration! ("+GetObjectName(pX)+")")endifset Be[id]=CreateTrigger()call TriggerAddCondition(Be[id],Condition(YX))endfunctionfunction zX takes unit u returns nothing
...
set Le=0
set oe=Player(6)
call GroupEnumUnitsInRect(xe,Fn,le)set OO=(Le>=$A)set Le=0
set oe=Player(0)
...
return false
endifif(pc>Yo and Mx)then
return false
endifif(zx>0 and cX(IMaxBJ(pl,pr)*zx,IMinBJ(pl,pr))*2>pq+pc)thenreturn false
endifreturn trueendfunctionfunction dO takes boolean fl returns nothing
...
returnendifcall DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00Random Ban Race|r has been chosen. Number of bans: |cffFFFF00"+I2S(IAbsBJ(wx))+"|r.")endfunctionfunction tO takes integer PO returns nothing
if(PO==0)thenset wx=1
else
set wx=POendifif(not cO())then
call DisplayTextToPlayer(Player(0),.0,.0,"|cffFF0000Too many players for Ban Race mode!|r")set wx=0
returnendifcall DisplayTextToForce(bj_FORCE_ALL_PLAYERS,"|cffC6FF00Ban Race|r has been chosen. Number of bans per team: |cffFFFF00"+I2S(wx)+"|r.")endfunctionfunction TO takes integer PO returns nothing
if(PO==0)thenset zx=1
else
set zx=POendifset Wx=0
if(not cO())then
...
exitwhen wo[i]==pR or i>=Yoset i=i+1endloopcall RemoveUnit(u)set u=nullif(i>=Yo)thenreturn false
endifset To[dE]=uo[i]
if(GetLocalPlayer()==Player(dE))then
call StartSound(Wo[i])endifif(So!=null)then
set to=dEcall TriggerEvaluate(So)
endifreturn false
endfunctionfunction PR takes nothing returns nothingset Uo[Yo]="Chaos Legions"set uo[Yo]='h00O'set wo[Yo]='A0DD'set Wo[Yo]=CreateSound("Units\\Demon\\HeroPitLord\\HPitLordYesAttack2.wav",false,false,false,$A,$A,"DefaultEAXON")set Yo=Yo+1set Uo[Yo]="Elven Union"
set uo[Yo]='h00P'set wo[Yo]='A0DE'set Wo[Yo]=CreateSound("Units\\Critters\\BloodElfPeasant\\BloodElfEngineerWarcry1.wav",false,false,false,$A,$A,"DefaultEAXON")set Yo=Yo+1set Uo[Yo]="Corrupted Conglomerate"set uo[Yo]='u006'set wo[Yo]='A0DF'set Wo[Yo]=CreateSound("Units\\Demon\\Pitlord\\PitLordYesAttack1.wav",false,false,false,$A,$A,"DefaultEAXON")set Yo=Yo+1set Uo[Yo]="Human Alliance"set uo[Yo]='h00C'set wo[Yo]='A0DG'set Wo[Yo]=CreateSound("Units\\Human\\Peasant\\PeasantReady1.wav",false,false,false,$A,$A,"DefaultEAXON")set Yo=Yo+1set Uo[Yo]="Orcish Horde"set uo[Yo]='h019'set wo[Yo]='A0DH'set Wo[Yo]=CreateSound("Units\\Orc\\Peon\\PeonReady1.wav",false,false,false,$A,$A,"DefaultEAXON")set Yo=Yo+1set Uo[Yo]="Naga Faction"set uo[Yo]='h00E'set wo[Yo]='A0DI'set Wo[Yo]=CreateSound("Units\\Creeps\\Murloc\\MurlocPissed2.wav",false,false,false,$A,$A,"DefaultEAXON")set Yo=Yo+1set Uo[Yo]="Northern Realms"
set uo[Yo]='h017'set wo[Yo]='A0DJ'set Wo[Yo]=CreateSound("Units\\Creeps\\Bandit\\BanditWhat1.wav",false,false,false,$A,$A,"DefaultEAXON")set Yo=Yo+1set Uo[Yo]="Night Elfs"set uo[Yo]='h089'set wo[Yo]='A0DK'set Wo[Yo]=CreateSound("Units\\NightElf\\Runner\\RunnerWarcry1.wav",false,false,false,$A,$A,"DefaultEAXON")set Yo=Yo+1set Uo[Yo]="Undead Forces"set uo[Yo]='h018'set wo[Yo]='A0DL'set Wo[Yo]=CreateSound("Units\\Undead\\Acolyte\\AcolyteWarcry1.wav",false,false,false,$A,$A,"HeroAcksEAX")set Yo=Yo+1set Uo[Yo]="Mech Coalition"set uo[Yo]='h06P'set wo[Yo]='A0DM'set Wo[Yo]=CreateSound("Units\\Creeps\\HeroTinker\\HeroTinkerReady1.wav",false,false,false,$A,$A,"HeroAcksEAX")set Yo=Yo+1set Uo[Yo]="Nature Force"set uo[Yo]='h01A'set wo[Yo]='A0DN'set Wo[Yo]=CreateSound("Units\\NightElf\\Ent\\EntReady1.wav",false,false,false,$A,$A,"DefaultEAXON")
set Yo=Yo+1set Uo[Yo]="Elementals' Universe"set uo[Yo]='h051'set wo[Yo]='A0DO'set Wo[Yo]=CreateSound("Units\\NightElf\\Wisp\\WispPissed3.wav",false,false,false,$A,$A,"DefaultEAXON")set Yo=Yo+1set Uo[Yo]="Desert Plains"set uo[Yo]='h06N'set wo[Yo]='A0GL'set Wo[Yo]=CreateSound("Units\\Creeps\\Kobold\\KoboldPissed3.wav",false,false,false,$A,$A,"DefaultEAXON")set Yo=Yo+1call DisableTrigger(zo)call TriggerAddCondition(zo,Condition(function MR))call TriggerRegisterAnyUnitEventBJ(zo,EVENT_PLAYER_UNIT_SPELL_CAST)endfunctionfunction qR takes nothing returns booleanlocal unit u=GetFilterUnit()
...
set ue[dE]=s
call ZO(dE)set jr[dE]=truecall DisplayTextToForce(bj_FORCE_ALL_PLAYERS,qo[dE]+" (AI) joined to game")endfunctionfunction SI takes integer dE returns boolean
if(not jr[dE])thenreturn false
endifset jr[dE]=false
...
endifset i=i+1exitwhen i>$Bendloopendfunctionfunction TI takes integer dE returns nothing
if(Vr[dE])thenset Vr[dE]=false
...
endifcall DisplayTimedTextToPlayer(p,.0,.0,15.,"Units killed: |cffFFFF00"+I2S(Bo[id])+"|r (|cffFFFF00"+I2S(GetPlayerState(Player(id),PLAYER_STATE_RESOURCE_GOLD)+jo[id]+Jo[id]-Ho[id]-Do[id]-ho[id]-$FA)+"|r gold in total)")
...
call DialogSetMessage(Hi,"New races after each round?")set ji[0]=DialogAddButton(Hi,"YES",0)set ji[1]=DialogAddButton(Hi,"NO",0)
...
local trigger tlocal unit u=GetEnumUnit()local real dtif(GetWidgetLife(u)>.405)thenset dt=I2R(qi-GetUnitBuildTime(ie[GetUnitPointValue(u)]))if(dt>0)then
...
call TX(ce,'h050',270.,.0,28.)call TX(ce,'h050',90.,.0,-28.)return false
endfunctionfunction bb takes nothing returns booleancall TX(ce,'h04Y',270.,.0,28.)call TX(ce,'h050',90.,.0,-28.)return false
endfunctionfunction Bb takes nothing returns booleancall TX(ce,'h04Y',270.,.0,28.)call TX(ce,'h04Y',90.,.0,-28.)return false
endfunctionfunction cb takes nothing returns booleancall TX(ce,'h04Y',270.,.0,28.)call TX(ce,'h050',90.,.0,-28.)return false
endfunctionfunction Cb takes nothing returns booleancall TX(ce,'h04Y',270.,.0,28.)call TX(ce,'h04Y',90.,.0,-28.)call TX(ce,'h058',270.,.0,.0)return false
endfunctionfunction db takes nothing returns booleancall TX(ce,'h04Y',270.,.0,28.)call TX(ce,'h050',90.,.0,-28.)call TX(ce,'h052',270.,.0,.0)return false
endfunctionfunction Db takes nothing returns booleancall TX(ce,'h04Y',270.,.0,28.)call TX(ce,'h04Y',90.,.0,-28.)call TX(ce,'h053',270.,.0,.0)return false
endfunctionfunction fb takes nothing returns booleancall TX(ce,'h04Y',270.,.0,28.)call TX(ce,'h050',90.,.0,-28.)call TX(ce,'h05O',270.,.0,.0)return false
endfunctionfunction Fb takes nothing returns booleancall TX(ce,'h04Y',270.,.0,28.)call TX(ce,'h04Y',90.,.0,-28.)call TX(ce,'h057',270.,.0,.0)call TX(ce,'h05P',270.,.0,.0)return false
endfunctionfunction gb takes nothing returns booleancall TX(ce,'h050',270.,.0,28.)call TX(ce,'h050',90.,.0,-28.)return false
endfunctionfunction Gb takes nothing returns booleancall TX(ce,'h04Y',270.,.0,28.)call TX(ce,'h050',90.,.0,-28.)call TX(ce,'h05K',90.,.0,.0)
return false
endfunctionfunction hb takes nothing returns booleancall TX(ce,'h04Y',270.,.0,28.)call TX(ce,'h04Y',90.,.0,-28.)call TX(ce,'h05B',90.,.0,.0)
return false
endfunctionfunction Hb takes nothing returns booleancall TX(ce,'h04Y',270.,.0,28.)call TX(ce,'h04Y',90.,.0,-28.)call TX(ce,'h05Y',270.,.0,.0)call TX(ce,'h05Q',270.,.0,.0)call TX(ce,'h05S',270.,.0,.0)call TX(ce,'h05W',270.,.0,.0)return false
endfunctionfunction jb takes nothing returns booleancall TX(ce,'h065',300.,.0,.0)return false
endfunctionfunction Jb takes nothing returns booleancall TX(ce,'h066',270.,.0,.0)return false
endfunctionfunction kb takes nothing returns booleancall TX(ce,'h067',270.,.0,.0)return false
endfunctionfunction Kb takes nothing returns booleancall TX(ce,'h064',270.,.0,.0)return false
endfunctionfunction Lb takes nothing returns nothingcall SX('h03Y','h02X')call SX('h03Z','h02Y')call SX('h040','h034')call SX('h041','h03N')call SX('h042','h03P')call SX('h044','h03R')call SX('h045','h02Z')call SX('h046','h030')call SX('h04A','o00C')call SX('h04C','o00D')call SX('h04D','o00E')call SX('h04E','h03V')call yX('h03Y',function bb)call yX('h03Z',function Bb)call yX('h040',function cb)call yX('h041',function Cb)call yX('h042',function db)call yX('h044',function Db)call yX('h045',function fb)call yX('h046',function Fb)call yX('h04A',function gb)call yX('h04C',function Gb)call yX('h04D',function hb)call yX('h04E',function Hb)call yX('h05Z',function Jb)call yX('h060',function jb)call yX('h061',function kb)call yX('h063',function Kb)call vO('h060',function Nb)call vO('h05Z',function Ob)call vO('h062',function Rb)call ZX('h061',850.)
...
call UnitAddAbility(u,'A0EZ')call wI(u)endifendifset u=nullendfunctionfunction OB takes nothing returns booleancall SetUnitVertexColor(ce,$FF,$FF,$FF,0)call TX(ce,'h0A0',170.,31.25,-43.)call TX(ce,'h0A0',80.,-38.,-40.25)call TX(ce,'h0A0',350.,-30.25,30.)call TX(ce,'h08Z',220.,43.,27.5)
return false
endfunctionfunction RB takes nothing returns nothingcall SX('h000','hfoo')call SX('h039','h03A')call SX('h003','hrif')call SX('h0A1','h05C')call yX('h0A1',function OB)call SX('h05D','h0A2')call SX('h004','hmtm')call ZX('h006',950.)
call SX('h00K','n005')call ZX('h010',500.)
...
set c=nullendifendfunctionfunction kB takes nothing returns booleancall TX(ce,'h09V',270.,.0,.0)call TX(ce,'h09U',90.,20.,.0)call TX(ce,'h09U',.0,.0,-20.)call TX(ce,'h09U',270.,-20.,.0)call TX(ce,'h09U',180.,.0,20.)return false
endfunctionfunction KB takes nothing returns booleancall TX(ce,'h09R',300.,3.5,65.25)call TX(ce,'h09R',70.,-16.5,-51.)call TX(ce,'h09N',238.,36.,53.)call TX(ce,'h09O',314.,-38.,-39.5)return false
endfunctionfunction lB takes nothing returns booleancall TX(ce,'h09O',279.,-45.5,24.75)call TX(ce,'h09N',300.,31.,-32.25)return false
endfunctionfunction LB takes nothing returns booleancall TX(ce,'h09K',238.,.0,.0)return false
endfunctionfunction mB takes nothing returns booleancall TX(ce,'h09F',2.,36.25,41.)call TX(ce,'h09F',2.,33.25,-33.5)call TX(ce,'h09F',2.,-46.25,10.75)call TX(ce,'h09A',45.,-5.25,17.)
return false
endfunctionfunction MB takes nothing returns booleancall TX(ce,'h09D',225.,35.,-29.75)call TX(ce,'h09D',45.,20.,22.5)call TX(ce,'h09D',225.,-31.,26.25)call TX(ce,'h09G',23.,-25.25,-36.)return false
endfunctionfunction pB takes nothing returns booleancall SetUnitFacing(ce,.7)call TX(ce,'h09D',45.,35.,-29.75)call TX(ce,'h09D',45.,20.,22.5)call TX(ce,'h09D',-45.,-31.,26.25)call TX(ce,'h09G',23.,-25.25,-36.)return false
endfunctionfunction PB takes nothing returns booleancall TX(ce,'h09C',33.,36.25,36.5)call TX(ce,'h09C',13.,21.,-47.5)
call TX(ce,'h09C',319.,-46.25,11.75)
return false
endfunctionfunction qB takes nothing returns booleancall TX(ce,'h09C',33.,36.25,36.5)call TX(ce,'h09C',13.,21.,-47.5)
call TX(ce,'h09C',319.,-46.25,11.75)
call TX(ce,'h09E',348.,-6.5,9.)return false
endfunctionfunction Mechanical___Animationh05L takes nothing returns booleancall TX(ce,'h09K',45.,.0,.0)
return false
endfunctionfunction QB takes nothing returns booleancall TX(ce,'h096',180.,-45.75,21.75)
call TX(ce,'h096',110.,9.,-62.5)
return false
endfunctionfunction sB takes nothing returns nothingcall yX('h09T',function kB)call ZX('h09T',180.)
call SX('h069','n01U')call yX('h069',function KB)call vO('h06J',function gB)call vO('h05R',function GB)call SX('h05T','z002')call SX('h09P','z003')call yX('h09P',function lB)call SX('h05U','n01T')call SX('h05M','n01V')call SX('h06D','n02G')call SX('h05J','h06Q')call SX('h09L','h06R')call yX('h09L',function LB)call SX('h05V','n01X')call SX('h097','n024')call yX('h097',function QB)call SX('h05X','h06T')call SX('h09J','h06U')call yX('h09J',function mB)call SX('h09I','h099')call yX('h09I',function MB)call SX('h06G','h06F')call SX('h077','h075')call yX('h077',function pB)call SX('h09B','h06S')call yX('h09B',function PB)call SX('h09H','h098')call yX('h09H',function qB)call ZX('h05L',600.)
call yX('h05L',function jB)endfunctionfunction SB takes nothing returns nothingcall LX(9)call MX('h05T',.2,true,0)call MX('h09P',.2,true,'h05T')call MX('h05U',.2,true,0)call MX('h05M',.2,true,0)call MX('h06D',.2,true,'h05M')call MX('h05J',.2,true,0)call MX('h09L',.2,true,'h05J')call MX('h05V',.2,true,0)call MX('h097',.2,false,'h05V')call MX('h05X',.2,true,0)call MX('h09J',.2,true,'h05X')call MX('h09I',.2,true,'h05X')call MX('h077',.2,false,'h09I')call MX('h06G',.18,true,'h05X')call MX('h09B',.2,true,'h05X')call MX('h09H',.2,true,'h09B')call MX('h09T',.12,false,0)call MX('h069',.12,false,0)call MX('h06J',.12,false,0)call MX('h05R',.12,false,'h06J')
...
set c=nullendfunctionfunction Bc takes nothing returns booleancall TX(ce,'h02J',270.,.0,.0)return false
endfunctionfunction Cc takes nothing returns booleancall TX(ce,'h02J',270.,.0,.0)call TX(ce,'h02E',270.,.0,.0)return false
endfunctionfunction dc takes nothing returns booleancall TX(ce,'h02J',270.,.0,.0)call TX(ce,'h02E',270.,.0,.0)call TX(ce,'h02F',270.,-25.,-25.)return false
endfunctionfunction Dc takes nothing returns booleancall TX(ce,'h02J',270.,.0,.0)call TX(ce,'h02E',270.,.0,.0)call TX(ce,'h02F',270.,-35.,-40.)call TX(ce,'h02G',211.,-35.,35.)
return false
endfunctionfunction fc takes nothing returns booleancall TX(ce,'h02Q',270.,-35.,30.)
return false
endfunctionfunction Fc takes nothing returns booleancall TX(ce,'h02L',270.,.0,.0)call TX(ce,'h02M',270.,25,20.)return false
endfunctionfunction gc takes nothing returns booleancall TX(ce,'h02T',49.,-40.,20.)return false
endfunctionfunction Gc takes nothing returns nothingcall SX('n02C','n00T')call yX('n02C',function Bc)call SX('h002','n00U')call yX('h002',function Cc)call SX('h00Q','n01N')call yX('h00Q',function dc)call SX('h00R','n01W')call yX('h00R',function Dc)call SX('h00Y','n026')call SX('h012','n028')call yX('h012',function fc)call SX('h013','e006')call SX('h01H','e009')call SX('h01J','e00C')call SX('h023','n029')call SX('h024','n02B')call yX('h024',function Fc)call SX('h027','n02A')call SX('h028','e00F')call yX('h028',function gc)call ZX('n02D',700.)
...
endfunctionfunction zC takes integer PV returns nothing
...
local unit u=GetTriggerUnit()local player p=GetOwningPlayer(u)local item it=GetManipulatedItem()local integer uX=GetItemTypeId(it)if(uX=='I004')thencall RemoveItem(it)if(lx)thenset JE=GetPlayerId(p)set Jo[JE]=Jo[JE]+($5DC)
...
call RemoveUnit(c)set c=nullset Eo[Mo[dE]]=0
set Fo[dE]=R2I(zD)set go[dE]=wXset Vo[Mo[dE]]=Vo[Mo[dE]]-1if(Vo[Mo[dE]]==0)thencall AO(1,Mo[dE]+1,"|cffFF00000|r")else
call AO(1,Mo[dE]+1,I2S(Vo[Mo[dE]]))endifcall NO(te[dE],Mo[dE]*6+1," ")if(wX==0)thencall DisplayTextToForce(bj_FORCE_ALL_PLAYERS,qo[dE]+" wasted his Devastating Strike, killing no unit! Epic Fail!")elseif(wX==1)thencall DisplayTextToForce(bj_FORCE_ALL_PLAYERS,qo[dE]+" wasted his Devastating Strike, killing only one unit!")else
call DisplayTextToForce(bj_FORCE_ALL_PLAYERS,qo[dE]+" dealt |cffFFFF00"+I2S(Fo[dE])+"|r damage with his Devastating Strike and killed |cffFFFF00"+I2S(wX)+"|r units!")endifendfunctionfunction vf takes unit u,real tx,real ty returns nothing
